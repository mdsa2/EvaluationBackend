...
namespace EvaluationBackend.Repository
{
    public class UserRepository : GenericRepository<AppUser,Guid>, IUserRepository
    {
        ...
        public async Task<(List<AppUser> data, int totalCount)> GetUsers(Expression<Func<AppUser, bool>> predicate, Func<IQueryable<AppUser>, IIncludableQueryable<AppUser, object>> include, int pageNumber = 0)
        {
